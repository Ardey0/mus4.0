...
public class IntakeBall extends CommandBase {
    ...
    public void execute() {
        ...
        telemetry.addData("culoare sector 1: ", roata.getSector(1));
        telemetry.addData("culoare sector 2: ", roata.getSector(2));
        telemetry.addData("culoare sector 3: ", roata.getSector(3));
    }
