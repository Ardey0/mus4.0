...
public class LaunchAllBallsSetPower extends CommandBase {
    ...
    private final Timing.Timer paleteTimer = new Timing.Timer(450, TimeUnit.MILLISECONDS);
    ...
    public LaunchAllBallsSetPower(RobotStorage robotStorage, TelemetryManager telemetry, PaleteSubsytem paleteSubsytem,
